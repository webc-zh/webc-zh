import { i as e, n as l, r as s, t } from "./MdGithub-BIlLQnEE.js";
import { A as r, C as n, E as o, H as a, I as v, L as i, N as c, P as h, R as f, S as b, T as w, U as p, _ as d, a as u, b as g, c as x, d as m, g as z, h as k, i as y, j as T, k as _, l as j, o as q, p as A, r as C, v as E, x as I, y as H, z as L } from "./index-BnyknPJp.js";
var P = I("<b class=\"svelte-f13ene\"><h1 class=\"svelte-f13ene\"> </h1><!></b>"), R = I("<h2 class=\"svelte-f13ene\"> </h2>"), S = I("<h3 class=\"svelte-f13ene\"> </h3>"), V = I("<h4 class=\"svelte-f13ene\"> </h4>"), W = I("<h5 class=\"svelte-f13ene\"> </h5>"), $ = I("<h6 class=\"svelte-f13ene\"> </h6>"), D = I("<section class=\"svelte-f13ene\"><!><!><!><!><!><!><!></section>"), G = I("<v-scroll><b class=\"svelte-f13ene\"><article class=\"svelte-f13ene\"></article></b></v-scroll>", 2), M = {
	hash: "svelte-f13ene",
...
function N(r, n) {
	L(n, !0), A(r, M);
	let b = q(n, "name", 7), u = q(n, "readme", 7), g = q(n, "scrollTo", 15), y = h(null), C = v(() => "WebC" == b() ? s : l("com/" + b())), I = v(() => Array.isArray(u()) ? u() : []);
	g((e) => {
		if (!w(y)) return;
...
var O = I("<button> </button>"), U = I("<v-scroll><b class=\"svelte-1u69se2\"><b class=\"svelte-1u69se2\">章节导航</b><b class=\"svelte-1u69se2\"></b></b></v-scroll>", 2), X = {
	hash: "svelte-1u69se2",
...
function B(e, l) {
	...
	return k(h, 21, s, z, (e, l) => {
		...
		a(r), o(() => {
			m(r, 1, `level-${w(s)[0] ?? ""}`, "svelte-1u69se2"), E(i, w(s)[1]);
...
var F = I("<b class=\"wait svelte-1ww8mwq\"></b>"), J = I("<!><!>", 1), K = {
	hash: "svelte-1ww8mwq",
...
function Q(e, l) {
	...
	y(async () => {
		c(t, (await C(() => import("./readme-BE7x3T3i.js"), [], import.meta.url)).default), c(s, w(t)[0]?.[1] || "WebC.site", !0), c(n, !1);
	});
	var i = g(), b = r(i), p = (e) => {
		H(e, F());
	}, u = (e) => {
